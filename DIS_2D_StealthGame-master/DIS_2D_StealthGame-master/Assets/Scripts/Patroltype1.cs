...
public class Patroltype1 : MonoBehaviour
{
    ...
    private bool WallCheck()
    {
        ...
        Vector3 helpervector = (Mathf.Abs(rb.linearVelocity.x) > Mathf.Abs(rb.linearVelocity.y)) ? new Vector3(transform.position.x + (rb.linearVelocity.x / rb.linearVelocity.x)*walldetectdistance, transform.position.y, 0) : 
                                                                                       new Vector3(transform.position.x, transform.position.y + (rb.linearVelocity.y / rb.linearVelocity.y)*walldetectdistance, 0);
